    ...
    slider.init = function () {
      ...
      if (slider.vars.controlsContainer != "") {
        slider.controlsContainer = $(slider.vars.controlsContainer).eq(
          $(".slides2").index(slider.container),
        );
      ...
      if (slider.vars.animation.toLowerCase() == "slide") {
        ...
        if (slider.vars.animationLoop) {
          ...
          slider.container
            .append(slider.slides2.filter(":first").clone().addClass("clone"))
            .prepend(slider.slides2.filter(":last").clone().addClass("clone"));
        }
        ...
        if (slider.vertical) {
          ...
          setTimeout(function () {
            slider
              ...
              .height(slider.slides2.filter(":first").height());
            ...
            if (slider.vertical) {
              ...
              slider.args[slider.prop] =
                -1 *
                  ...
                  slider.slides2.filter(":first").height() +
                "px";
              if (slider.transitions) {
                slider.setTransition(0);
                slider.args[slider.prop] = slider.vertical
      ...
      if (!slider.animating && slider.is(":visible")) {
        ...
        if (slider.vars.animation.toLowerCase() == "slide") {
          var dimension = slider.vertical
            ? slider.slides2.filter(":first").height()
            : slider.slides2.filter(":first").width();
